...
/// Re-exports and mocks of mundis-program modules that mirror those from
/// mundis-program.
///
/// This lets examples in mundis-program appear to be written as client
/// programs.
pub mod mundis_sdk {
    pub use crate::hash;
