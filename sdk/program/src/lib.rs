...
// Allows macro expansion of `use ::mundis_program::*` to work within this crate
extern crate self as mundis_program;
...
pub mod token_vault {
    pub mod program {
        crate::declare_id!("TokenVau1t111111111111111111111111111111111");
    }
}
...
/// use std::str::FromStr;
/// use mundis_program::{declare_id, pubkey::Pubkey};
///
/// # mod item_wrapper {
/// #   use mundis_program::declare_id;
...
/// assert_eq!(id(), my_id);
/// ```
pub use mundis_sdk_macro::program_declare_id as declare_id;
...
/// ```
/// use std::str::FromStr;
/// use mundis_program::{pubkey, pubkey::Pubkey};
///
...
/// assert_eq!(ID, my_id);
/// ```
pub use mundis_sdk_macro::program_pubkey as pubkey;
...
/// ```compile_fail
/// # use mundis_program::unchecked_div_by_const;
/// # fn main() {
