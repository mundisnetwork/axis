//! Mundis Rust-based BPF program entry point supported by the latest
...
/// errors. To avoid this, it is common for Mundis programs to define an
...
///
/// # Defining a panic handler for Mundis
///
/// _The mechanism for defining a Mundis panic handler is different [from most
...
/// ```
///
/// The above is how Mundis defines the default panic handler.
#[macro_export]
