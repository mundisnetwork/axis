//! Types for directing the execution of Mundis programs.
//!
//! Every invocation of a Mundis program executes a single instruction, as
...
//! the Mundis runtime. This allows flexibility in how programs behave, how they
...
pub enum InstructionError {
    ...
    /// by the Mundis runtime. A program-specific error may be any type that is represented as
    ...
    /// consistent across Mundis software versions.
    ///
...
/// A directive for a single invocation of a Mundis program.
///
/// An instruction specifies which program it is calling, which accounts it may
/// read or modify, and additional data that serves as input to the program. One
/// or more instructions are included in transactions submitted by Mundis
...
/// construction.
///
/// While Mundis is agnostic to the format of the instruction data, it has
...
///
/// When building a transaction, the Mundis runtime coalesces all accounts used
...
///
/// Note that because the Mundis runtime schedules parallel transaction
...
/// which is the core of a Mundis transaction. It is created during the
