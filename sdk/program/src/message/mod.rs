...
//!
//! In Mundis, programs execute instructions, and clients submit sequences
...
//!
//! Despite living in the `mundis-program` crate, there is no way to access the
//! runtime's messages from within a Mundis program, and only the legacy message
//! types continue to be exposed to Mundis programs, for backwards compatibility
//! reasons.
