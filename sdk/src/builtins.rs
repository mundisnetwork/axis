...
/// use mundis_sdk::declare_builtin;
///
...
///
/// # use item_wrapper::id;
/// assert_eq!(id(), mundis_sdk::system_program::ID);
/// ```
#[macro_export]
