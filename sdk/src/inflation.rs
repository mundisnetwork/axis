...
const DEFAULT_INITIAL: f64 = 0.11750;
const DEFAULT_TERMINAL: f64 = 0.04;
const DEFAULT_TAPER: f64 = 0.085;
...
mod tests {
    ...
    fn test_inflation_basic() {
        ...
        for year in &[0.1, 0.5, 1.0, DEFAULT_FOUNDATION_TERM, 100.0] {
            ...
            assert!(
                total - (inflation.validator(*year) + inflation.foundation(*year)) < 10.0.pow(-10)
            );
            assert!(total < last);
