...
// Allows macro expansion of `use ::mundis_sdk::*` to work within this crate
extern crate self as mundis_sdk;
...
pub use mundis_sdk_macro::declare_deprecated_id;
...
/// use std::str::FromStr;
/// use mundis_sdk::{declare_id, pubkey::Pubkey};
///
/// # mod item_wrapper {
/// #   use mundis_sdk::declare_id;
...
/// assert_eq!(id(), my_id);
/// ```
pub use mundis_sdk_macro::declare_id;
...
/// assert_eq!(ID, my_id);
/// ```
pub use mundis_sdk_macro::pubkey;
pub use mundis_sdk_macro::pubkeys;
