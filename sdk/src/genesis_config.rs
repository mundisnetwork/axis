...
pub struct GenesisConfig {
    ...
    /// with the Mundis v1.9 release line
    pub __backwards_compat_with_v1_9: u64,
...
impl Default for GenesisConfig {
    fn default() -> Self {
        Self {
            ...
            __backwards_compat_with_v1_9: 0,
    ...
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(
            ...
            "\
             ...
             {:?}\n\
             {:?}\n\
             Capitalization: {} MUNDIS in {} accounts\n\
...
mod tests {
    ...
    fn test_genesis_config() {
        ...
        config.add_native_instruction_processor("hi".to_string(), mundis_sdk::pubkey::new_rand());
