use {
    ...
    mundis_program::{account_info::AccountInfo, debug_account_data::*, sysvar::Sysvar},
    std::{
        cell::{Ref, RefCell},
        fmt,
        rc::Rc,
...
pub fn create_account_with_fields<S: Sysvar>(
    ...
    let mut account = Account::new(lamports, data_len, &mundis_program::sysvar::id());
...
impl mundis_program::account_info::Account for Account {
