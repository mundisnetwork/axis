use {
    ...
    regex::Regex,
    mundis_download_utils::download_file,
    mundis_sdk::signature::{write_keypair_file, Keypair},
    std::{
...
fn install_if_missing(
    ...
    // Check whether the package is already in ~/.cache/mundis.
...
fn build_bpf_package(config: &Config, target_directory: &Path, package: &cargo_metadata::Package) {
    ...
    if let Some(program_name) = program_name {
        ...
        println!();
        println!("Success:");
        println!("  program library {}", program_so.display());
    ...
    let matches = App::new(crate_name!())
        ...
        .arg(
            Arg::with_name("bpf_sdk")
                ...
                .help("Path to the Mundis BPF SDK"),
        )
        .arg(
