...
impl StakesCache {
    ...
    pub fn is_stake(account: &AccountSharedData) -> bool {
        mundis_vote_program::check_id(account.owner())
    ...
    pub fn check_and_store(
        ...
        if mundis_vote_program::check_id(account.owner()) {
        ...
        } else if mundis_stake_program::check_id(account.owner()) {
...
pub mod tests {
    use {
        ...
        mundis_sdk::{account::WritableAccount, pubkey::Pubkey, rent::Rent},
        mundis_stake_program::stake_state,
        mundis_vote_program::vote_state::{self, VoteState, VoteStateVersions},
    };
    ...
    pub fn create_staked_node_accounts(
        ...
        let vote_account =
            vote_state::create_account(&vote_pubkey, &mundis_sdk::pubkey::new_rand(), 0, 1);
        (
