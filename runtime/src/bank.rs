...
#[allow(deprecated)]
use mundis_sdk::recent_blockhashes_account;
use {
    crate::{
        accounts::{
    ...
    mundis_metrics::{inc_new_counter_debug, inc_new_counter_info},
...
impl Bank {
            ...
            stakes
                ...
                .for_each(|(stake_pubkey, delegation)| {
                    ...
                    let stake_delegation = match self.get_account_with_fixed_root(stake_pubkey) {
                        Some(stake_account) => {
                            if stake_account.owner() != &mundis_stake_program::id() {
                                invalid_stake_keys
                        ...
                        vote_with_stake_delegations_map.get_mut(vote_pubkey)
                    {
                        ...
                        let vote_account = match self.get_account_with_fixed_root(vote_pubkey) {
                            Some(vote_account) => {
                                if vote_account.owner() != &mundis_vote_program::id() {
                                    invalid_vote_keys
    ...
    fn use_multi_epoch_collection_cycle(&self, epoch: Epoch) -> bool {
        ...
        #[cfg(not(test))]
        if self.slot_count_per_normal_epoch() == mundis_sdk::epoch_schedule::MINIMUM_SLOTS_PER_EPOCH
        {
            return false;
        }
...
pub(crate) mod tests {
    #[allow(deprecated)]
    use mundis_sdk::sysvar::fees::Fees;
    use {
        super::*,
        crate::{
    ...
    #[allow(clippy::float_cmp)]
    fn test_bank_new() {
        let dummy_leader_pubkey = mundis_sdk::pubkey::new_rand();
    ...
    fn test_rent_distribution() {
        ...
        let bootstrap_validator_pubkey = mundis_sdk::pubkey::new_rand();
        ...
        let validator_1_pubkey = mundis_sdk::pubkey::new_rand();
        ...
        let validator_2_pubkey = mundis_sdk::pubkey::new_rand();
        ...
        let validator_3_pubkey = mundis_sdk::pubkey::new_rand();
    ...
    fn test_rent_exempt_executable_account() {
        ...
        let mut account =
            AccountSharedData::new(account_balance, data_len, &mundis_sdk::pubkey::new_rand());
    ...
    fn test_rent_eager_across_epoch_without_gap_under_multi_epoch_cycle() {
        let leader_pubkey = mundis_sdk::pubkey::new_rand();
    ...
    fn map_to_test_bad_range() -> std::collections::BTreeMap<Pubkey, i8> {
        ...
        map.insert(mundis_sdk::pubkey::new_rand(), 1);
        map
    }
    ...
    fn test_rent_eager_collect_rent_in_partition() {
        ...
        let zero_lamport_pubkey = mundis_sdk::pubkey::new_rand();
        let rent_due_pubkey = mundis_sdk::pubkey::new_rand();
        let rent_exempt_pubkey = mundis_sdk::pubkey::new_rand();
    ...
    fn do_test_bank_update_rewards_determinism() -> u64 {
        ...
        let vote_id = mundis_sdk::pubkey::new_rand();
        let mut vote_account =
            vote_state::create_account(&vote_id, &mundis_sdk::pubkey::new_rand(), 50, 100);
    ...
    fn test_transfer_to_sysvar() {
        ...
        let normal_pubkey = mundis_sdk::pubkey::new_rand();
    ...
    fn test_bank_tx_fee() {
        ...
        let leader = mundis_sdk::pubkey::new_rand();
        let GenesisConfigInfo {
            mut genesis_config,
            mint_keypair,
            ..
    ...
    fn test_readonly_accounts() {
        let GenesisConfigInfo {
            ...
            mint_keypair,
            ..
        } = create_genesis_config_with_leader(500, &mundis_sdk::pubkey::new_rand(), 0);
        let bank = Bank::new_for_tests(&genesis_config);

        let vote_pubkey0 = mundis_sdk::pubkey::new_rand();
        let vote_pubkey1 = mundis_sdk::pubkey::new_rand();
        let vote_pubkey2 = mundis_sdk::pubkey::new_rand();
    ...
    fn test_bank_hash_internal_state() {
        ...
        let pubkey2 = mundis_sdk::pubkey::new_rand();
    ...
    fn test_bank_hash_internal_state_verify() {
        ...
        let bank2 = Bank::new_from_parent(&bank0, &mundis_sdk::pubkey::new_rand(), 1);
        ...
        bank2.update_accounts_hash();
        assert!(bank2.verify_bank_hash(true));
        let bank3 = Bank::new_from_parent(&bank0, &mundis_sdk::pubkey::new_rand(), 2);
    ...
    fn test_hash_internal_state_order() {
        ...
        let bank1 = Bank::new_for_tests(&genesis_config);
        assert_eq!(bank0.hash_internal_state(), bank1.hash_internal_state());
        let key0 = mundis_sdk::pubkey::new_rand();
        let key1 = mundis_sdk::pubkey::new_rand();
    ...
    fn test_bank_update_sysvar_account() {
        ...
        let dummy_clock_id = mundis_sdk::pubkey::new_rand();
    ...
    fn test_bank_inherit_tx_count() {
        ...
        // Bank 2
        let bank2 = Bank::new_from_parent(&bank0, &mundis_sdk::pubkey::new_rand(), 2);
        ...
        let bank6 = Bank::new_from_parent(&bank1, &mundis_sdk::pubkey::new_rand(), 3);
        assert_eq!(bank1.transaction_count(), 1);
    ...
    fn test_bank_vote_accounts() {
        let GenesisConfigInfo {
            ...
            mint_keypair,
            ..
        } = create_genesis_config_with_leader(500, &mundis_sdk::pubkey::new_rand(), 1);
        let bank = Arc::new(Bank::new_for_tests(&genesis_config));
    ...
    fn test_is_delta_with_no_committables() {
        ...
        assert_eq!(
            bank.transfer(10_001, &mint_keypair, &mundis_sdk::pubkey::new_rand()),
            Err(TransactionError::InstructionError(
                0,
                SystemError::ResultWithNegativeLamports.into(),
            ))
    ...
    fn test_bank_get_program_accounts() {
        ...
        assert!(
            genesis_accounts
                .iter()
                .any(|(pubkey, _, _)| mundis_sdk::sysvar::is_sysvar_id(pubkey)),
            "no sysvars found"
        );

        let bank0 = Arc::new(new_from_parent(&parent));
        let pubkey0 = mundis_sdk::pubkey::new_rand();
        ...
        let pubkey1 = mundis_sdk::pubkey::new_rand();
    ...
    fn test_add_duplicate_static_program() {
        ...
        let vote_loader_account = bank.get_account(&mundis_vote_program::id()).unwrap();
        bank.add_builtin(
            "mundis_vote_program",
            &mundis_vote_program::id(),
            mock_vote_processor,
        );
        let new_vote_loader_account = bank.get_account(&mundis_vote_program::id()).unwrap();
    ...
    fn test_transaction_with_duplicate_accounts_in_instruction() {
        ...
        let from_pubkey = mundis_sdk::pubkey::new_rand();
        let to_pubkey = mundis_sdk::pubkey::new_rand();
    ...
    fn test_account_ids_after_program_ids() {
        ...
        let instruction =
            Instruction::new_with_bincode(mundis_vote_program::id(), &10, account_metas);
        let mut tx = Transaction::new_signed_with_payer(
            &[instruction],
            Some(&mint_keypair.pubkey()),
            &[&mint_keypair],
        ...
        tx.message.account_keys.push(mundis_sdk::pubkey::new_rand());
        ...
        let result = bank.process_transaction(&tx);
        assert_eq!(result, Ok(()));
        let account = bank.get_account(&mundis_vote_program::id()).unwrap();
    ...
    fn test_program_id_as_payer() {
        ...
        tx.message.account_keys.push(mundis_vote_program::id());
    ...
    fn test_fuzz_instructions() {
        ...
        let program_keys: Vec<_> = (0..max_programs)
            .enumerate()
            .map(|i| {
                let key = mundis_sdk::pubkey::new_rand();
    ...
    fn test_same_program_id_uses_unqiue_executable_accounts() {
        ...
        // Add a new program
        let program1_pubkey = mundis_sdk::pubkey::new_rand();
        bank.add_builtin("program", &program1_pubkey, nested_processor);

        // Add a new program owned by the first
        let program2_pubkey = mundis_sdk::pubkey::new_rand();
    ...
    fn test_add_builtin_loader_no_overwrite() {
        ...
        let slot = 123;
        let loader_id = mundis_sdk::pubkey::new_rand();
    ...
    fn test_reconfigure_token2_native_mint() {
        ...
        let mut genesis_config =
            create_genesis_config_with_leader(5, &mundis_sdk::pubkey::new_rand(), 0).genesis_config;
    ...
    fn test_ensure_no_storage_rewards_pool() {
        ...
        let reward_pubkey = mundis_sdk::pubkey::new_rand();
        genesis_config.rewards_pools.insert(
            reward_pubkey,
            Account::new(u64::MAX, 0, &mundis_sdk::pubkey::new_rand()),
        );
        let bank0 = Bank::new_for_tests(&genesis_config);
    ...
    fn test_rent_for_sysvars_adjustment_full_set() {
        ...
        fn mock_process_instruction(
            ...
            _data: &[u8],
            _invoke_context: &mut InvokeContext,
        ) -> std::result::Result<(), mundis_sdk::instruction::InstructionError> {
            Ok(())
        }
            ...
            ) + std::marker::Send,
    {
        ...
        let all_pubkeys: Vec<Pubkey> = std::iter::repeat_with(mundis_sdk::pubkey::new_rand)
            .take(total_pubkeys)
            .collect();
    ...
    fn test_get_inflation_start_slot_devnet_testnet() {
        let GenesisConfigInfo {
            mut genesis_config, ..
        } = create_genesis_config_with_leader(42, &mundis_sdk::pubkey::new_rand(), 42);
        genesis_config
            .accounts
    ...
    fn test_get_largest_accounts() {
        ...
        // Initialize accounts; all have larger MUN balances than current Bank built-ins
        ...
        assert_eq!(
            bank.get_largest_accounts(1, &pubkeys_hashset, AccountAddressFilter::Include)
                .unwrap(),
            vec![(pubkeys[4], mun_to_lamports(5.0))]
        );
        assert_eq!(
        ...
        assert_eq!(
            bank.get_largest_accounts(1, &exclude4, AccountAddressFilter::Exclude)
                .unwrap(),
            vec![(pubkeys[3], mun_to_lamports(4.0))]
        );
    ...
    fn test_call_precomiled_program() {
        ...
        let instruction = mundis_sdk::secp256k1_instruction::new_secp256k1_instruction(
            &secp_privkey,
            message_arr,
        );
        let tx = Transaction::new_signed_with_payer(
        ...
        let message_arr = b"hello";
        let instruction =
            mundis_sdk::ed25519_instruction::new_ed25519_instruction(&privkey, message_arr);
        let tx = Transaction::new_signed_with_payer(
            &[instruction],
            Some(&mint_keypair.pubkey()),
            &[&mint_keypair],
    ...
    fn test_calculate_fee_compute_units() {
        ...
        for pair in expected_fee_structure.iter() {
            ...
            assert_eq!(
                fee,
                mun_to_lamports(pair.1) + lamports_per_signature + ADDITIONAL_FEE
            );
        }
    }
    ...
    fn test_an_empty_instruction_without_program() {
        let (genesis_config, mint_keypair) = create_genesis_config(1);
        let destination = mundis_sdk::pubkey::new_rand();
    ...
    fn test_max_accounts_data_size_exceeded() {
        use {
            mundis_program_runtime::accounts_data_meter::MAX_ACCOUNTS_DATA_LEN,
            mundis_sdk::system_instruction::MAX_PERMITTED_DATA_LENGTH,
        };
        ...
        assert!(matches!(
            ...
            Err(TransactionError::InstructionError(
                _,
                mundis_sdk::instruction::InstructionError::MaxAccountsDataSizeExceeded,
            ))
        ));
    }
    ...
    fn test_invalid_rent_state_changes_existing_accounts() {
        let GenesisConfigInfo {
            ...
            mint_keypair,
            ..
        } = create_genesis_config_with_leader(mun_to_lamports(100.), &Pubkey::new_unique(), 42);
    ...
    fn test_rent_state_changes_sysvars() {
        ...
        let validator_pubkey = mundis_sdk::pubkey::new_rand();
        let validator_stake_lamports = mun_to_lamports(1.);
    ...
    fn test_invalid_rent_state_changes_fee_payer() {
        ...
        genesis_config.fee_rate_governor = FeeRateGovernor::new(
            mundis_sdk::fee_calculator::DEFAULT_TARGET_LAMPORTS_PER_SIGNATURE,
            mundis_sdk::fee_calculator::DEFAULT_TARGET_SIGNATURES_PER_SLOT,
        );
    ...
    fn test_rent_state_incinerator() {
        ...
        for amount in [rent_exempt_minimum - 1, rent_exempt_minimum] {
            bank.transfer(amount, &mint_keypair, &mundis_sdk::incinerator::id())
                .unwrap();
        }
    }
    ...
    fn test_resize_and_rent() {
        ...
        let rent_paying_pubkey = mundis_sdk::pubkey::new_rand();
