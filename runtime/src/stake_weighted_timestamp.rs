...
pub mod tests {
    use {
        super::*,
        mundis_sdk::{account::Account, native_token::mdis_to_lamports},
    };
    ...
    fn test_calculate_stake_weighted_timestamp_uses_median() {
        ...
        let pubkey3 = mundis_sdk::pubkey::new_rand();
        let pubkey4 = mundis_sdk::pubkey::new_rand();
        ...
        let stakes: HashMap<Pubkey, (u64, Account)> = [
            (
                pubkey0,
                (mdis_to_lamports(1.0), Account::new(1, 0, &Pubkey::default())),
            ),
            (
                pubkey1,
                (mdis_to_lamports(1.0), Account::new(1, 0, &Pubkey::default())),
        ...
        let stakes: HashMap<Pubkey, (u64, Account)> = [
            (
                pubkey0,
                (
                    mdis_to_lamports(1_000_000.0), // 1/3 stake
                    Account::new(1, 0, &Pubkey::default()),
                ),
            ),
            (
        ...
        let stakes: HashMap<Pubkey, (u64, Account)> = [
            (
                pubkey0,
                (
                    mdis_to_lamports(1_000_001.0), // 1/3 stake
                    Account::new(1, 0, &Pubkey::default()),
                ),
            ),
            (
