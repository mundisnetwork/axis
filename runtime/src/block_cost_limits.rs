...
lazy_static! {
    ...
    pub static ref BUILT_IN_INSTRUCTION_COSTS: HashMap<Pubkey, u64> = [
        ...
        (mundis_sdk::stake::config::id(), COMPUTE_UNIT_TO_US_RATIO * 2),
        (mundis_sdk::stake::program::id(), COMPUTE_UNIT_TO_US_RATIO * 25),
        (mundis_config_program::id(), COMPUTE_UNIT_TO_US_RATIO * 15),
        (mundis_vote_program::id(), COMPUTE_UNIT_TO_US_RATIO * 70),
