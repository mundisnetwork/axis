#[allow(deprecated)]
use mundis_sdk::sysvar::recent_blockhashes;
use {
    serde::{Deserialize, Serialize},
    mundis_sdk::{fee_calculator::FeeCalculator, hash::Hash, timing::timestamp},
...
mod tests {
    ...
    use {
        super::*,
        bincode::serialize,
        mundis_sdk::{clock::MAX_RECENT_BLOCKHASHES, hash::hash},
    };
