use {
    ...
    mundis_vote_program::{vote_instruction::VoteInstruction, vote_state::Vote},
};
...
pub fn parse_sanitized_vote_transaction(tx: &SanitizedTransaction) -> Option<ParsedVote> {
    ...
    if !mundis_vote_program::check_id(program_id) {
        return None;
    }
