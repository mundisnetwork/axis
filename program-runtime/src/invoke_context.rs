...
pub fn with_mock_invoke_context<R, F: FnMut(&mut InvokeContext) -> R>(
    ...
    let keyed_accounts = [
        (
            ...
            false,
            loader_id,
            AccountSharedData::new_ref(0, 0, &mundis_sdk::native_loader::id()),
        ),
        (
            false,
            false,
...
mod tests {
    ...
    fn test_program_entry_debug() {
        ...
        let builtin_programs = &[
            BuiltinProgram {
                program_id: mundis_sdk::pubkey::new_rand(),
    ...
    fn test_invoke_context() {
        ...
        for i in 0..MAX_DEPTH {
            invoke_stack.push(mundis_sdk::pubkey::new_rand());
            accounts.push((
            ...
            accounts.push((
                *program_id,
                Rc::new(RefCell::new(AccountSharedData::new(
                    1,
                    1,
                    &mundis_sdk::pubkey::Pubkey::default(),
                ))),
            ));
    ...
    fn test_process_cross_program() {
        let caller_program_id = mundis_sdk::pubkey::new_rand();
        let callee_program_id = mundis_sdk::pubkey::new_rand();

        let owned_account = AccountSharedData::new(42, 1, &callee_program_id);
        let not_owned_account = AccountSharedData::new(84, 1, &mundis_sdk::pubkey::new_rand());
        let readonly_account = AccountSharedData::new(168, 1, &mundis_sdk::pubkey::new_rand());
    ...
    fn test_process_instruction_accounts_data_meter() {
        ...
        // Test 3: Resize the account to exceed the budget; this must fail
        {
            ...
            assert!(matches!(
                result,
                Err(mundis_sdk::instruction::InstructionError::MaxAccountsDataSizeExceeded)
            ));
            assert_eq!(invoke_context.accounts_data_meter.remaining(), 0);
        }
    }
