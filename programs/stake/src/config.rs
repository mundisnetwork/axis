...
#[deprecated(
    since = "1.8.0",
    note = "Please use `mundis_sdk::stake::config` or `mundis_program::stake::config` instead"
)]
pub use mundis_sdk::stake::config::*;
use {
    bincode::deserialize,
    mundis_config_program::{create_config_account, get_config_data},
    mundis_sdk::{
...
#[cfg(test)]
mod tests {
    use {super::*, mundis_sdk::pubkey::Pubkey, std::cell::RefCell};
