...
impl VoteState {
    ...
    fn get_max_sized_vote_state() -> VoteState {
        ...
        for i in 0..=MAX_LEADER_SCHEDULE_EPOCH_OFFSET {
            authorized_voters.insert(i, mundis_sdk::pubkey::new_rand());
        }
...
mod tests {
    ...
    impl VoteState {
        pub fn new_for_test(auth_pubkey: &Pubkey) -> Self {
            Self::new(
                &VoteInit {
                    node_pubkey: mundis_sdk::pubkey::new_rand(),
    ...
    fn test_initialize_vote_account() {
        let vote_account_pubkey = mundis_sdk::pubkey::new_rand();
        ...
        let node_pubkey = mundis_sdk::pubkey::new_rand();
    ...
    fn create_test_account_with_authorized() -> (Pubkey, Pubkey, Pubkey, RefCell<AccountSharedData>)
    {
        ...
        let authorized_withdrawer = mundis_sdk::pubkey::new_rand();
    ...
    fn test_vote_signature() {
        ...
        let keyed_accounts = &[KeyedAccount::new(&vote_pubkey, false, &vote_account)];
        let signers: HashSet<Pubkey> = get_signers(keyed_accounts);
        let authorized_voter_pubkey = mundis_sdk::pubkey::new_rand();
        let res = authorize(
            &keyed_accounts[0],
        ...
        let keyed_accounts = &[KeyedAccount::new(&vote_pubkey, true, &vote_account)];
        let signers: HashSet<Pubkey> = get_signers(keyed_accounts);
        let authorized_withdrawer_pubkey = mundis_sdk::pubkey::new_rand();
        let res = authorize(
            &keyed_accounts[0],
        ...
        let another_authorized_voter_pubkey = mundis_sdk::pubkey::new_rand();
        let signers: HashSet<Pubkey> = get_signers(keyed_accounts);
    ...
    fn test_vote_double_lockout_after_expiration() {
        let voter_pubkey = mundis_sdk::pubkey::new_rand();
    ...
    fn test_process_missed_votes() {
        let account_a = mundis_sdk::pubkey::new_rand();
        let mut vote_state_a = VoteState::new_for_test(&account_a);
        let account_b = mundis_sdk::pubkey::new_rand();
    ...
    fn test_vote_state_withdraw() {
        ...
        // partial valid withdraw, after 7txXZZD6 feature activation
        {
            ...
            let res = withdraw(
                &keyed_accounts[0],
                withdraw_lamports,
                &KeyedAccount::new(&mundis_sdk::pubkey::new_rand(), false, &to_account),
                &signers,
                Some(&rent_sysvar),
                Some(&Clock::default()),
            );
    ...
    fn test_get_and_update_authorized_voter() {
        let original_voter = mundis_sdk::pubkey::new_rand();
        ...
        let new_authorized_voter = mundis_sdk::pubkey::new_rand();
        vote_state
    ...
    fn test_set_new_authorized_voter() {
        ...
        let new_voter = mundis_sdk::pubkey::new_rand();
        ...
        let new_voter2 = mundis_sdk::pubkey::new_rand();
        vote_state
        ...
        let new_voter3 = mundis_sdk::pubkey::new_rand();
        vote_state
