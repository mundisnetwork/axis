use {
    ...
    mundis_transaction_status::UiTransactionEncoding,
...
impl ClusterQuerySubCommands for App<'_, '_> {
    fn cluster_query_subcommands(self) -> Self {
        ...
        .subcommand(
            SubCommand::with_name("supply").about("Get information about the cluster supply of MUN")
            .arg(
        ...
        .subcommand(
            SubCommand::with_name("total-supply").about("Get total number of MUN")
            ...
            SubCommand::with_name("rent")
                ...
                .arg(
                    Arg::with_name("lamports")
                        .long("lamports")
                        .takes_value(false)
                        .help("Display rent in lamports instead of MUN"),
                ),
        )
    }
}
...
pub fn process_catchup(
    ...
    loop {
        ...
        // especially if pointing to api.meinnet.mundis.io at times
...
pub fn process_total_supply(rpc_client: &RpcClient, _config: &CliConfig) -> ProcessResult {
    ...
    Ok(format!("{} MUN", lamports_to_mun(supply.total)))
}
...
pub fn process_show_stakes(
    ...
    let mut program_accounts_config = RpcProgramAccountsConfig {
        account_config: RpcAccountInfoConfig {
            encoding: Some(mundis_account_decoder::UiAccountEncoding::Base64),
...
mod tests {
    use {
        ...
        mundis_sdk::signature::{write_keypair, Keypair},
        std::str::FromStr,
