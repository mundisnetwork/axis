use {
    ...
    mundis_cli_output::CliNonceAccount,
    mundis_client::{nonce_utils::*, rpc_client::RpcClient},
    ...
    fn nonce_subcommands(self) -> Self {
            ...
            SubCommand::with_name("create-nonce-account")
                ...
                .arg(
                    Arg::with_name("amount")
                        ...
                        .help("The amount to load the nonce account with, in MUN; accepts keyword ALL"),
                )
                .arg(
        ...
        .subcommand(
            SubCommand::with_name("withdraw-from-nonce-account")
                .about("Withdraw MUN from the nonce account")
                .arg(
                    pubkey!(Arg::with_name("nonce_account_pubkey")
                        .index(1)
                        .value_name("NONCE_ACCOUNT_ADDRESS")
                ...
                .arg(
                    pubkey!(Arg::with_name("destination_account_pubkey")
                        ...
                        .required(true),
                        "The account to which the MUN should be transferred. "),
                )
                .arg(
                    Arg::with_name("amount")
                        .index(3)
                        ...
                        .required(true)
                        .validator(is_amount)
                        .help("The amount to withdraw from the nonce account, in MUN"),
                )
                .arg(nonce_authority_arg())
                .arg(memo_arg()),
        )
...
mod tests {
    ...
    fn test_check_nonce_account() {
        ...
        let nonce_pubkey = mundis_sdk::pubkey::new_rand();
