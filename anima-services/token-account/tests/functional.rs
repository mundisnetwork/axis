...
use mundis_program::{instruction::*, program_pack::Pack, pubkey::Pubkey, system_instruction};
use mundis_program_test::*;
use mundis_sdk::{
    signature::Signer,
    transaction::{Transaction, TransactionError},
};
use anima_token_account::*;
...
fn program_test(token_mint_address: Pubkey) -> ProgramTest {
    ...
    //      $ mundis account EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v \
...
async fn test_associated_token_address() {
    ...
    let expected_token_account_balance = rent.minimum_balance(anima_token::state::Account::LEN);
    ...
    assert_eq!(
        ...
        anima_token::state::Account::LEN
    );
    assert_eq!(associated_account.owner, anima_token::id());
