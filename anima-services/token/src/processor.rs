...
mod tests {
    ...
    use mundis_sdk::account::{
        create_account_for_test, create_is_signer_account_infos, Account as MundisAccount,
    };

    fn do_process_instruction(
        instruction: Instruction,
        accounts: Vec<&mut MundisAccount>,
    ) -> ProgramResult {
    ...
    fn test_initialize_mint() {
        ...
        let mut mint_account = MundisAccount::new(42, Mint::get_packed_len(), &program_id);
        let mint2_key = Pubkey::new_unique();
        let mut mint2_account =
            MundisAccount::new(mint_minimum_balance(), Mint::get_packed_len(), &program_id);
    ...
    fn test_initialize_mint_account() {
        ...
        let mut account_account = MundisAccount::new(42, Account::get_packed_len(), &program_id);
        let owner_key = Pubkey::new_unique();
        let mut owner_account = MundisAccount::default();
        let mint_key = Pubkey::new_unique();
    ...
    fn test_transfer_dups() {
        ...
        let mut account1_account = MundisAccount::new(
        ...
        let mut account2_account = MundisAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
            &program_id,
        );
        ...
        let mut account3_account = MundisAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
            &program_id,
        );
        ...
        let mut account4_account = MundisAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
            &program_id,
        );
        ...
        let mut multisig_account = MundisAccount::new(
    ...
    fn test_transfer() {
        let program_id = crate::id();
        let account_key = Pubkey::new_unique();
        let mut account_account = MundisAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
            &program_id,
        );
        ...
        let mut delegate_account = MundisAccount::default();
        let mismatch_key = Pubkey::new_unique();
        let mut mismatch_account = MundisAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
            &program_id,
        );
        ...
        let mut owner2_account = MundisAccount::default();
        let mint_key = Pubkey::new_unique();
        let mut mint_account =
            MundisAccount::new(mint_minimum_balance(), Mint::get_packed_len(), &program_id);
        let mint2_key = Pubkey::new_unique();
    ...
    fn test_set_authority() {
        ...
        let mut owner3_account = MundisAccount::default();
        let mint_key = Pubkey::new_unique();
        let mut mint_account =
            MundisAccount::new(mint_minimum_balance(), Mint::get_packed_len(), &program_id);
        let mint2_key = Pubkey::new_unique();
    ...
    fn test_mint_to() {
        ...
        let mut uninitialized_account = MundisAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
            &program_id,
        );
    ...
    fn test_multisig() {
        ...
        let mut mint_account =
            MundisAccount::new(mint_minimum_balance(), Mint::get_packed_len(), &program_id);
        let account_key = Pubkey::new_unique();
        let mut account = MundisAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
            &program_id,
        );
        ...
        let mut owner_account = MundisAccount::default();
        let multisig_key = Pubkey::new_unique();
        let mut multisig_account = MundisAccount::new(42, Multisig::get_packed_len(), &program_id);
        let multisig_delegate_key = Pubkey::new_unique();
        let mut multisig_delegate_account = MundisAccount::new(
            multisig_minimum_balance(),
            Multisig::get_packed_len(),
            &program_id,
        );
        ...
        let mut signer_accounts = vec![MundisAccount::new(0, 0, &program_id); MAX_SIGNERS];
        let mut rent_sysvar = rent_sysvar();
    ...
    fn test_close_account() {
        ...
        let owner2_key = Pubkey::new_unique();
        let mut owner2_account = MundisAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
            &program_id,
        );
    ...
    fn test_native_token() {
        ...
        let account3_key = Pubkey::new_unique();
        let mut account3_account = MundisAccount::new(account_minimum_balance(), 0, &program_id);
        let owner_key = Pubkey::new_unique();
        let mut owner_account = MundisAccount::default();
        let owner2_key = Pubkey::new_unique();
        let mut owner2_account = MundisAccount::default();
    ...
    fn test_overflow() {
        ...
        let mut mint_owner_account = MundisAccount::default();
        let mint_key = Pubkey::new_unique();
        let mut mint_account =
            MundisAccount::new(mint_minimum_balance(), Mint::get_packed_len(), &program_id);
        let mut rent_sysvar = rent_sysvar();
    ...
    fn test_freeze_account() {
        ...
        let mut account_owner_account = MundisAccount::default();
        let owner_key = Pubkey::new_unique();
        let mut owner_account = MundisAccount::default();
        let owner2_key = Pubkey::new_unique();
        let mut owner2_account = MundisAccount::default();
    ...
    fn test_sync_native() {
        ...
        let lamports = 40;
        let mut native_account = MundisAccount::new(
            account_minimum_balance() + lamports,
            Account::get_packed_len(),
            &program_id,
        );
        let non_native_account_key = Pubkey::new_unique();
        let mut non_native_account = MundisAccount::new(
