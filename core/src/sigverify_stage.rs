...
use {
    ...
    mundis_perf::sigverify::{count_valid_packets, shrink_batches, Deduper},
    mundis_sdk::timing,
    mundis_streamer::streamer::{self, PacketBatchReceiver, StreamerError},
    std::{
...
impl SigVerifyStage {
    ...
    fn verifier_service<T: SigVerifier + 'static + Send + Clone>(
        ...
        Builder::new()
            .name("mundis-verifier".to_string())
            .spawn(move || {
...
mod tests {
    ...
    use mundis_perf::packet::to_packet_batches;
    use mundis_perf::test_tx::test_tx;
    use std::sync::mpsc::channel;
    use {super::*, mundis_perf::packet::Packet};
