...
pub use mundis_perf::report_target_features;
use {
    crate::{
    ...
    rand::{thread_rng, Rng},
    mundis_entry::poh::compute_hash_time_ns,
    mundis_geyser_plugin_manager::geyser_plugin_service::GeyserPluginService,
    mundis_gossip::{
        cluster_info::{
...
pub struct Validator {
    ...
    tpu: Tpu,
    tvu: Tvu,
    ip_echo_server: Option<mundis_net_utils::IpEchoServer>,
...
impl Validator {
    ...
    pub fn new(
        ...
        if mundis_perf::perf_libs::api().is_some() {
        ...
        *start_progress.write().unwrap() = ValidatorStartProgress::StartingServices;
        ...
        let ip_echo_server = match node.sockets.ip_echo {
            None => None,
            Some(tcp_listener) => Some(mundis_net_utils::ip_echo_server(
                tcp_listener,
...
fn new_banks_from_ledger(
    ...
    *start_progress.write().unwrap() = ValidatorStartProgress::LoadingLedger;
    ...
    if let Some(warp_slot) = config.warp_slot {
        ...
        bank_forks.set_root(
            warp_slot,
            &mundis_runtime::accounts_background_service::AbsRequestSender::default(),
            Some(warp_slot),
        );
...
mod tests {
    use {
        ...
        mundis_ledger::{create_new_tmp_ledger, genesis_utils::create_genesis_config_with_leader},
        mundis_sdk::{genesis_config::create_genesis_config, poh_config::PohConfig},
    ...
    fn test_backup_and_clear_blockstore() {
        ...
        use {
            mundis_entry::entry,
            mundis_ledger::{blockstore, get_tmp_ledger_path},
        };
    ...
    fn test_poh_speed() {
        ...
        let poh_config = PohConfig {
            target_tick_duration: Duration::from_millis(mundis_sdk::clock::MS_PER_TICK),
            // make PoH rate really fast to cause the panic condition
            hashes_per_tick: Some(100 * mundis_sdk::clock::DEFAULT_HASHES_PER_TICK),
            ..PohConfig::default()
        };
