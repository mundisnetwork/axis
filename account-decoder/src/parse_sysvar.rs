#[allow(deprecated)]
use mundis_sdk::sysvar::{fees::Fees, recent_blockhashes::RecentBlockhashes};
use {
    crate::{
...
mod test {
    #[allow(deprecated)]
    use mundis_sdk::sysvar::recent_blockhashes::IterItem;
    use {
        super::*,
        mundis_sdk::{account::create_account_for_test, fee_calculator::FeeCalculator, hash::Hash},
    };
    ...
    fn test_parse_sysvars() {
        ...
        let bad_pubkey = mundis_sdk::pubkey::new_rand();
