use {
    ...
    bincode::deserialize,
    serde_json::Value,
    mundis_config_program::{get_config_data, ConfigKeys},
    mundis_sdk::{
        pubkey::Pubkey,
...
mod test {
    use {
        ...
        mundis_config_program::create_config_account, mundis_sdk::account::ReadableAccount,
    };
    ...
    fn test_parse_config() {
        ...
        let info_pubkey = mundis_sdk::pubkey::new_rand();
        ...
        assert_eq!(
            ...
            ConfigAccountType::ValidatorInfo(UiConfig {
                ...
                config_data: serde_json::from_str(r#"{"name":"Mundis"}"#).unwrap(),
            }),
        );
