//! lockups generator
use {
    mundis_sdk::{clock::Epoch, epoch_schedule::EpochSchedule, timing::years_as_slots},
    std::time::Duration,
};
...
#[cfg(test)]
mod tests {
    use mundis_sdk::native_token::LAMPORTS_PER_MUNDIS;
    use super::*;
    ...
    fn test_make_lockups() {
        ...
        let total_lamports: u64 = 400_000_000 * LAMPORTS_PER_MUNDIS;
