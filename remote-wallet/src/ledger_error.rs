...
pub enum LedgerError {
    #[error("Mundis app not open on Ledger device")]
    ...
    #[error("Ledger received invalid Mundis message")]
    MundisInvalidMessage = 0x6a80,

    #[error("Mundis summary finalization failed on Ledger device")]
    MundisSummaryFinalizeFailed = 0x6f00,

    #[error("Mundis summary update failed on Ledger device")]
    MundisSummaryUpdateFailed = 0x6f01,
